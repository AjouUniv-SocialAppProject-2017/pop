...
import static com.example.kyu.sap.R.id.reg_projectImage;
...
//    private EditText et_join_pw_ok;
    ...
    private ImageView reg_profileImage;
...
//        et_join_pw_ok = (EditText)findViewById(R.id.et_join_pw_ok);
        ...
        reg_profileImage = (ImageView) findViewById(R.id.join_profile);
        //방 이미지 등록
        reg_profileImage.setImageResource(R.drawable.photo);
        ...
        if(requestCode == 100)
        {
            if(resultCode== Activity.RESULT_OK)
            {
                try {
                    ...
                    ImageView image = (ImageView) findViewById(R.id.join_profile);
