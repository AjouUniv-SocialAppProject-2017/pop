...
public class LoginActivity extends AppCompatActivity {
    ...
    public static String current_user_name = "홍길동";
    public static String current_user_major;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_id = (EditText) findViewById(R.id.loginid);
        edit_pw = (EditText) findViewById(R.id.loginpw);
        ...
        while (i.hasNext()) {
            ...
            if(loginId.getText().toString().equals(imsi_id)) {
                ...
                if(loginPw.getText().toString().equals(imsi_pw)){
                    su = 2;
                    //현재 로그인정보 내부적으로 저장
                    current_user_name = user.getUser_name();
                    current_user_major = user.getMajor();
                }
            }
        }
...
//                startActivity(new Intent(LoginActivity.this, MainActivity.class));
                ...
                }else if(edit_pw.getText().toString().length() == 0){
